...
<script type="text/javascript" src="resource/js/news_onload.js"></script>
			...
			<div id="login">
				...
				<div id="articles">
					...
					<security:authorize
						...
						<sf:form modelAttribute="news" method="post" id="arti"
					...
					<ul id="pages_ul">
						...
						<a id="totalPage" onclick="turnTopage()"></a>
						</li>
					</ul>
				</div>
			</div>
